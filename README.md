...
See https://v-os.dev/download/ and https://docs.v-os.dev/docs/getting-started/how-to-install/

### Getting Started

* [Building](https://docs.v-os.dev/docs/getting-started/building/)
* [Coding Guidelines](https://docs.v-os.dev/docs/development/coding-guidelines/)
* [Filesystem Layout](https://docs.v-os.dev/docs/development/filesystem-layout/)
* [Full Wiki](https://docs.v-os.dev/)

We welcome contributions from the community. Check the wiki for guidelines and open issues on GitHub.

### Donate

If you'd like to support the project, see the [Donate](https://docs.v-os.dev/docs/reference/donate/) page.
