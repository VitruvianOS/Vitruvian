 ...
 *
 * Ported from upstream, minus the CALLED()/<bluetooth/debug.h>
 * tracing macros (that header is part of the HCI machinery this port
 * deliberately does not bring in).
 */
