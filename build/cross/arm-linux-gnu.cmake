...
set(CMAKE_C_FLAGS_INIT "-march=armv7ve+neon-vfpv4 -mcpu=cortex-a7 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_C_FLAGS_INIT}")

include_directories(SYSTEM "${VITRUVIAN_CHROOT_PATH}/usr/include")
link_directories(
    "${VITRUVIAN_CHROOT_PATH}/usr/lib"
    "${VITRUVIAN_CHROOT_PATH}/lib"
)

set(CMAKE_EXE_LINKER_FLAGS_INIT "-flto")
